...
bool InitScene()
{
	...
	HRESULT hr;
	hr = D3DX11CompileFromFile("cube.fx", 0, 0, "VS", "vs_4_0", 0, 0, 0, &VS_Buffer, 0, 0);
	hr = D3DX11CompileFromFile("cube.fx", 0, 0, "PS", "ps_4_0", 0, 0, 0, &PS_Buffer, 0, 0);
	...
	hr = pDevice->CreateRasterizerState(&wfdesc, &pWireFrame);
