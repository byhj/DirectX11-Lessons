...
void Cube::init_buffer(ID3D11Device *pD3D11Device)
{
	///////////////////////////Index Buffer ////////////////////////////////
	m_VertexCount = 8;
	std::array<byhj::Vertex, 8> VertexData = 
	{
		byhj::Vertex( -1.0f, -1.0f, -1.0f,   1.0f, 0.0f, 0.0f, 1.0f ),
		byhj::Vertex( -1.0f, +1.0f, -1.0f,   0.0f, 1.0f, 0.0f, 1.0f ),
		byhj::Vertex( +1.0f, +1.0f, -1.0f,   0.0f, 0.0f, 1.0f, 1.0f ),
		byhj::Vertex( +1.0f, -1.0f, -1.0f,   1.0f, 1.0f, 0.0f, 1.0f ),
		byhj::Vertex( -1.0f, -1.0f, +1.0f,   0.0f, 1.0f, 1.0f, 1.0f ),
		byhj::Vertex( -1.0f, +1.0f, +1.0f,   1.0f, 1.0f, 1.0f, 1.0f ),
		byhj::Vertex( +1.0f, +1.0f, +1.0f,   1.0f, 0.0f, 1.0f, 1.0f ),
		byhj::Vertex( +1.0f, -1.0f, +1.0f,   1.0f, 0.0f, 0.0f, 1.0f ),
	};
