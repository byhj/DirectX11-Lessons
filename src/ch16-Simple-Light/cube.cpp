...
void Cube::init_buffer(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContext)
{
	...
	{
		// Front Face
		byhj::Vertex(-1.0f, -1.0f, -1.0f,  0.0f, 1.0f,-1.0f,  -1.0f, -1.0f),
		byhj::Vertex(-1.0f,  1.0f, -1.0f,  0.0f, 0.0f,-1.0f,   1.0f, -1.0f),
		byhj::Vertex( 1.0f,  1.0f, -1.0f,  1.0f, 0.0f, 1.0f,   1.0f, -1.0f),
		byhj::Vertex( 1.0f, -1.0f, -1.0f,  1.0f, 1.0f, 1.0f,  -1.0f, -1.0f),
	...
	cbLightDesc.ByteWidth      = sizeof(byhj::LightBuffer);
	...
	DebugHR(hr);
	byhj::LightBuffer *plightData = (byhj::LightBuffer *)mappedResource.pData;
