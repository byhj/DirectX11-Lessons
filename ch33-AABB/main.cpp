	...
	std::vector<std::wstring> texFileNameArray)
{
	...
	else
	{
		...
		std::wstring message = L"Could not open: ";
		message += filename;
		message += L". Please visit Braynzar Vision to download the model";
...
bool InitScene()
{
	...
	if(FAILED(hr))
	{
		...
		// create message
		std::wstring message = L"Could not open: skymap.dds. Please visit Braynzar Vision to download the Sky Map";
